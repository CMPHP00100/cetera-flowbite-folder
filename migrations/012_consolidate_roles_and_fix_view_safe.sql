...
-- 1. Drop the broken view first
DROP VIEW IF EXISTS user_summary;

-- 2. Rename existing users table
ALTER TABLE users RENAME TO users_old;

-- 3. Recreate users table with only STANDARD_USER and PREMIUM_USER roles
CREATE TABLE users (
    id TEXT PRIMARY KEY,
    name TEXT,
    email TEXT UNIQUE,
...
-- 4. Copy data from old table, mapping roles
INSERT INTO users (
...
-- 6. Recreate the view with updated columns
