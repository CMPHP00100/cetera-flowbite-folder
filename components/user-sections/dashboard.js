        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-orange-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{userStats.lastLogin}</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-orange-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{userStats.memberSince}</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-orange-500/20">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center text-sm">
              ...
              <span className="text-gray-500 ml-auto">3 months ago</span>
            </div>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-orange-500/20">
        ...
        <div className="space-y-4">
          <button className="w-full bg-gray-700 hover:bg-gray-600 text-white px-4 py-3 rounded-lg text-left transition-colors">
            Change Password
          </button>
          <button className="w-full bg-gray-700 hover:bg-gray-600 text-white px-4 py-3 rounded-lg text-left transition-colors">
