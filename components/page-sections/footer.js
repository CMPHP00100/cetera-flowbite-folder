...
const SOCIALS = [
  {
    id: "1",
    href: "#",
    className: "text-gray-500 hover:text-cetera-orange dark:hover:text-white",
    svglink:
            ...
            <div className="col-12 col-sm-12 col-md-4 md:mb-0">
              <a href="https://flowbite.com" className="flex items-center">
                <Image
                  ...
                  height="100"
                />
                <p className="self-center whitespace-nowrap text-gray-400 hover:text-cetera-orange">
                    ...
                    {RESOURCES.map(({ href, label }) => {
                      ...
                      return (
                        ...
                        <li key={href + label} className="mb-4">
                          <Link
                            href={href}
                            className={`${isActive ? "text-cetera-orange" : "text-gray-400"} hover:text-cetera-orange hover:brightness-50`}
                          >
                            {label}
                          </Link>
                        </li>
