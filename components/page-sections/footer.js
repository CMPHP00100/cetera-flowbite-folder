...
const SOCIALS = [
  {
    id: "1",
    href: "#",
    className: "facebook text-cetera-mono-orange hover:text-cetera-light-gray h-5 w-5",
    svglink:
  ...
  },
  {
    ...
    className: "instagram text-cetera-mono-orange hover:text-cetera-light-gray h-5 w-5",
    svglink:
  ...
  },
  {
    id: "3",
    href: "#",
    className: "twitter text-cetera-mono-orange hover:text-cetera-light-gray h-5 w-5",
    svglink:
  ...
  },
  {
    ...
    className: "tiktok text-cetera-mono-orange hover:text-cetera-light-gray h-6 w-6",
    svglink:
  ...
  },
  {
    id: "5",
    href: "#",
    className: "linkedin text-cetera-mono-orange hover:text-cetera-light-gray h-6 w-6 ms-3",
    svglink:
      ...
      <footer className="bg-cetera-dark-blue p-4 align-bottom sm:p-6">
        <div className="continer-fluid mx-auto">
            ...
            <div className="col-12 col-sm-12 col-md-4 md:mb-0">
              <a href="https://flowbite.com" className="flex items-center">
                <Image
                  ...
                  height="100"
                />
                <p className="self-center whitespace-nowrap text-gray-400 hover:text-cetera-mono-orange">
            ...
            <div className="col-12 col-sm-12 col-md-8">
              <div className="row mt-md-0 mt-4">
                ...
                <div className="col-6 col-sm-6 col-md-4 col-lg-3">
                  <h2 className="mb-2 text-sm font-semibold uppercase text-cetera-mono-orange">
                    Resources
                  </h2>
                    ...
                    {RESOURCES.map(({ href, label }) => {
                      ...
                      return (
                        ...
                        <li key={href + label} className="mb-2">
                          <Link
                            href={href}
                            className={`${isActive ? "text-cetera-mono-orange" : "text-gray-400"} hover:text-cetera-mono-orange`}
                          >
                            {label}
                          </Link>
                        </li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-cetera-mono-orange sm:text-center">
              © 2022{" "}
              <a href="https://ceteramarketing.com" className="hover:underline">
                Cétera Marketing™
              </a>
              . All Rights Reserved.
            </span>
