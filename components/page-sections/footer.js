...
const SOCIALS = [
  {
    id: "1",
    href: "#",
    className: "facebook text-cetera-dark-blue hover:text-cetera-mono-orange h-6 w-6",
    svglink:
  ...
  },
  {
    ...
    className: "instagram text-cetera-dark-blue hover:text-cetera-mono-orange h-6 w-6 ms-3",
    svglink:
  ...
  },
  {
    ...
    className: "twitter text-cetera-dark-blue hover:text-cetera-mono-orange h-6 w-6 ms-3",
    svglink:
  ...
  },
  {
    ...
    className: "tiktok text-cetera-dark-blue hover:text-cetera-mono-orange h-6 w-6 ms-3",
    svglink:
  ...
  },
  {
    id: "5",
    href: "#",
    className: "linkedin text-cetera-dark-blue hover:text-cetera-mono-orange h-6 w-6 ms-3",
    svglink:
...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-cetera-light-gray p-4 align-bottom sm:p-6">
        <div className="continer-fluid mx-auto">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-4 md:mb-0">
              <a href="/" className="flex items-center">
                <Image
                  src="/assets/logos/CM_logo_DarkBlue.svg"
                  className="h-8 mr-3 w-20"
                  alt="Cétera Marketing"
                  width="200"
                  height="100"
                />
                <p className="self-center whitespace-nowrap text-dark-blue hover:text-cetera-mono-orange">
                    ...
                    {RESOURCES.map(({ href, label }) => {
                      ...
                      return (
                        ...
                        <li key={href + label} className="mb-2">
                          <Link
                            href={href}
                            className={`${isActive ? "text-cetera-mono-orange" : "text-cetera-dark-blue"} hover:text-cetera-mono-orange`}
                          >
                            {label}
                          </Link>
                        </li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between pt-2">
            <span className="text-sm text-cetera-dark-blue sm:text-center">
              © 2022{" "}
              <a href="https://ceteramarketing.com" className="text-cetera-mono-orange hover:text-cetera-dark-blue">
                Cétera Marketing™
              </a>
              . All Rights Reserved.
            </span>
